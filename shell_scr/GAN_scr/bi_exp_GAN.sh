...
#$ -l h_rt=100:0:0              # Runtime length H:M:S
#$ -l h_vmem=1G                	# 11 * 8 = 88G total RAM
#$ -l gpu=4                     # Request 'X' GPUs
#$ -m bea                       # Emails alerts at job start, finish and abortion
#$ -M email@qmul.ac.uk   		# Email address for alerts
...
python train.py --outdir=gan_output/ --data=tt_bi_exp.zip --gpus=4 --cfg paper512 --cond=1 --mirror=1 --kimg 25000
